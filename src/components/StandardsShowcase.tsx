...
const standardsData = [
  ...
  {
    title: 'HCS-14: Deterministic Agent IDs',
    category: 'AI & Communication',
    status: 'draft' as const,
    description:
      'Standard for generating deterministic, globally unique identifiers for AI agents across all protocols, enabling universal agent discovery.',
    features: [
      'Universal IDs',
