      ...
      <div className='min-h-screen bg-white dark:bg-[#050505] font-sans text-gray-900 dark:text-white overflow-x-hidden selection:bg-[#5599fe] selection:text-white transition-colors duration-300'>
                 ...
                 <div className="grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    >
                        ...
                        <div className="flex flex-col sm:flex-row gap-8">
                            <PrimaryButton href="/docs/standards/hcs-20" className="!text-xl !px-12 !py-6 shadow-2xl shadow-blue-500/20 rounded-2xl flex items-center justify-center gap-3">
        ...
        <section className="py-24 relative z-10 overflow-hidden">
            ...
            <div className="container mx-auto px-6 2xl:px-0 max-w-[1400px]">
                ...
                <div className="grid xl:grid-cols-2 gap-12 mt-32">
                    <div className="bg-white dark:bg-black p-16 rounded-[4rem] border border-gray-200 dark:border-white/10 shadow-2xl relative overflow-hidden group">
                        <div className="absolute top-0 right-0 p-12 opacity-10 text-[15rem] text-[#a679f0] group-hover:scale-110 transition-transform">
                            <FaLock />
                        </div>
                        <div className="relative z-10">
                            <h3 className="text-5xl font-bold mb-8 text-[#a679f0]">Private Mode</h3>
                            <div className="inline-block px-6 py-2 bg-[#a679f0] text-white font-bold rounded-full mb-12">✅ Submit Key</div>
                            ...
                            <ul className="space-y-6 text-xl text-gray-500">
                    ...
                    <div className="bg-white dark:bg-black p-16 rounded-[4rem] border border-gray-200 dark:border-white/10 shadow-2xl relative overflow-hidden group">
                        <div className="absolute top-0 right-0 p-12 opacity-10 text-[15rem] text-[#48df7b] group-hover:scale-110 transition-transform">
                            <FaGlobe />
                        </div>
                        <div className="relative z-10">
                            <h3 className="text-5xl font-bold mb-8 text-[#48df7b]">Public Mode</h3>
                            <div className="inline-block px-6 py-2 bg-[#48df7b] text-white font-bold rounded-full mb-12">❌ No Submit Key</div>
                            <p className="text-2xl text-gray-600 dark:text-gray-400 leading-relaxed mb-12">
        ...
        <section className="py-24 relative z-10">
             <div className="container mx-auto px-6 2xl:px-0 max-w-[1400px]">
                 ...
                 <div className="grid xl:grid-cols-2 gap-12 mt-24">
                     <div>
                         <h4 className="text-3xl font-bold mb-8 text-[#5599fe]">Deploy</h4>
                     ...
                     <div>
                         <h4 className="text-3xl font-bold mb-8 text-[#5599fe]">Mint</h4>
                     ...
                     <div>
                         <h4 className="text-3xl font-bold mb-8 text-[#5599fe]">Transfer</h4>
                     ...
                     <div className="flex flex-col justify-center">
                         <div className="p-12 bg-white dark:bg-[#0f0f16] border border-[#a679f0]/30 rounded-[3rem]">
                             <FaHistory className="text-6xl text-[#a679f0] mb-8" />
                             <h4 className="text-3xl font-bold mb-4">Consensus Ordering</h4>
        ...
        <section className="py-24 border-t border-gray-200 dark:border-white/10 bg-gray-50 dark:bg-[#0a0b10]">
            <div className="container mx-auto px-6 2xl:px-0 max-w-[1400px] text-center">
                <h3 className="text-6xl font-bold mb-12">No Code Required.</h3>
                ...
                <div className="flex flex-col sm:flex-row justify-center gap-8">
                    <PrimaryButton href="https://patches-1.gitbook.io/hcs-20-auditable-points/download" className="!text-2xl !px-16 !py-8 shadow-2xl shadow-blue-500/20 rounded-2xl !bg-[#5599fe] hover:!bg-[#4a88e6]">
                        DOWNLOAD APP
                    </PrimaryButton>
                </div>
            </div>
