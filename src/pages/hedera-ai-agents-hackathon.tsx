...
const HederaAIAgentsHackathon: React.FC = () => {
  return (
    <Layout
      title='Hedera AI Agents Hackathon | OpenConvAI'
      description='Join the Hedera AI Agents Hackathon to build the future of AI communication on Hedera. $30,000 prize pool for AI agents and their humans.'
    >
...
export default HederaAIAgentsHackathon;
