  ...
  const targetAudience = [
    {
      ...
      description: 'Builders and maintainers of open agent, identity, and compute protocols',
      color: 'blue',
    },
    {
      icon: <FaUserTie />,
    ...
    },
    {
      ...
      description: 'Standards authors and contributors (W3C, IETF, EBSI, and others)',
      color: 'green',
    },
    {
      icon: <FaCloud />,
      title: 'Hyperscaler Developers',
      description: 'Developers at hyperscalers focused on agentic or privacy-preserving AI',
      color: 'blue',
    },
    {
      icon: <FaCubes />,
      title: 'Framework Teams',
      description: 'Teams building federated, DePIN, or Web3 frameworks for decentralized systems',
      color: 'purple',
    },
    {
      icon: <FaSearch />,
      title: 'Researchers & Auditors',
      description: 'Researchers, auditors, and governance leads working on interoperability',
      color: 'green',
    },
  ];
    ...
    >
      <main className='bg-gradient-to-br from-gray-50 via-blue-50 to-purple-50 dark:from-gray-900 dark:via-gray-950 dark:to-black relative overflow-hidden'>
        ...
        <div className='absolute inset-0 overflow-hidden pointer-events-none'>
          ...
          <div className='absolute top-40 right-20 w-96 h-96 bg-brand-purple/10 rounded-full blur-3xl animate-pulse' style={{ animationDelay: '1s' }}></div>
          <div className='absolute bottom-20 left-1/3 w-80 h-80 bg-brand-green/10 rounded-full blur-3xl animate-pulse' style={{ animationDelay: '2s' }}></div>
        </div>
        ...
        <section className='relative overflow-hidden py-12 lg:py-20'>
          ...
          <div className='absolute -bottom-40 -left-40 w-96 h-96 rounded-full bg-gradient-to-tr from-brand-blue/30 to-brand-green/20 blur-3xl animate-pulse' style={{ animationDelay: '1.5s' }}></div>
          ...
          <div className='container mx-auto px-6 lg:px-16 relative z-10'>
            ...
            >
              ...
              <h1 className='text-5xl lg:text-7xl font-mono font-bold mb-6'>
                <span className='text-gray-700 dark:text-white'>Patchwork: </span>
                <span
              ...
              <Typography className='text-lg lg:text-xl text-gray-600 dark:text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed'>
                A community working session bringing together AI standards builders to sync,
                align, and ensure interoperability for the agentic internet.
              </Typography>
          ...
          <div className='container mx-auto px-6 lg:px-16'>
            ...
            >
              <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8'>
                {[
                  { icon: <FaCalendarAlt />, title: 'Date', text: 'Tuesday, December 10, 2025', colors: 'from-blue-50 to-purple-50 dark:from-blue-900/30 dark:to-purple-900/30 border-blue-300 dark:border-blue-700', iconColor: 'text-brand-blue' },
                  { icon: <FaClock />, title: 'Time', text: '12:30–3:30 PM ET', colors: 'from-purple-50 to-pink-50 dark:from-purple-900/30 dark:to-pink-900/30 border-purple-300 dark:border-purple-700', iconColor: 'text-brand-purple' },
                  { icon: <FaGlobeAmericas />, title: 'Location', text: 'Virtual', colors: 'from-green-50 to-teal-50 dark:from-green-900/30 dark:to-teal-900/30 border-green-300 dark:border-green-700', iconColor: 'text-brand-green' },
                  { icon: <FaVideo />, title: 'Format', text: 'Talks, Panels & Discussions', colors: 'from-blue-50 to-cyan-50 dark:from-blue-900/30 dark:to-cyan-900/30 border-blue-300 dark:border-blue-700', iconColor: 'text-brand-blue' },
                ].map((detail, index) => (
                  <motion.div
                    key={detail.title}
                  ...
                  >
                    ...
                    <div className='relative z-10'>
                      <div className={`${detail.iconColor} text-3xl mx-auto mb-2`}>
                        {detail.icon}
                      </div>
          ...
          <div className='container mx-auto px-6 lg:px-16'>
            ...
            >
              <div className='text-center mb-12'>
                <Typography variant='h2' className='mb-4 bg-gradient-to-r from-brand-blue via-brand-purple to-brand-green bg-clip-text' style={{ WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>
                  Event Purpose
                </Typography>
                <Typography className='text-base text-gray-600 dark:text-gray-300 leading-relaxed'>
                  The AI ecosystem is rapidly producing new standards for agents, identity,
                  payments, and interoperability. Many projects are solving similar problems in
                  parallel, sometimes causing accidental incompatibilities.
                </Typography>
                <Typography className='text-base text-gray-600 dark:text-gray-300 leading-relaxed mt-4'>
                  Patchwork is a community working session designed as a "breather" — a chance for
                  everyone building these standards to sync, compare notes, and align on what's
                  needed for a cohesive, interoperable agentic internet.
                </Typography>
              </div>
              ...
              <div>
                <div className='grid grid-cols-1 lg:grid-cols-3 gap-8'>
                  {[
                    ...
                    >
                      <div className={`relative overflow-hidden rounded-2xl p-6 h-full transition-all duration-300 bg-gradient-to-br ${
                        ...
                        <div className='absolute inset-0 opacity-10'>
                          <div className={`absolute -top-10 -right-10 w-32 h-32 rounded-full blur-2xl animate-pulse ${
                            objective.color === 'blue'
                              ? 'bg-blue-400'
                              : objective.color === 'purple'
                              ? 'bg-purple-400'
        ...
        <section className='py-16 lg:py-24 bg-white dark:bg-gray-900'>
          <div className='container mx-auto px-6 lg:px-16'>
            ...
            >
              <Typography variant='h2' className='mb-6 bg-gradient-to-r from-brand-blue via-brand-purple to-brand-green bg-clip-text' style={{ WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>
                Hosted By
              </Typography>
              ...
              <Typography className='text-base text-gray-600 dark:text-gray-300 mb-12 leading-relaxed'>
                An industry association advancing enterprise-grade adoption of Proof-of-Control AI
                solutions that ensure verifiable trust among agents, humans, and infrastructure.
              </Typography>
              ...
              <div className='bg-gradient-to-br from-blue-50 to-purple-50 dark:from-gray-800 dark:to-gray-850 rounded-2xl p-6 border border-blue-200 dark:border-gray-700 mb-6'>
                ...
                <div className='flex justify-center items-center gap-3'>
                  <img
                    ...
                    style={{
                      filter: 'brightness(0) saturate(100%) invert(9%) sepia(5%) saturate(1298%) hue-rotate(202deg) brightness(95%) contrast(92%)',
                    }}
                  />
        ...
        <section className='py-16 lg:py-24 bg-gradient-to-br from-gray-50 via-blue-50 to-purple-50 dark:from-gray-900 dark:via-gray-950 dark:to-black'>
          <div className='container mx-auto px-6 lg:px-16'>
            ...
            >
              <Typography variant='h3' className='mb-6 bg-gradient-to-r from-brand-blue via-brand-purple to-brand-green bg-clip-text' style={{ WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>
                About Hashgraph Online
              </Typography>
              <Typography className='text-base text-gray-600 dark:text-gray-300 leading-relaxed'>
                Hashgraph Online is a consortium led by a DAO, building open-source standards (30M+
                mainnet transactions) and SDKs (1K+ weekly downloads) for the emerging agentic
                internet.
              </Typography>
              <div className='mt-8 flex justify-center gap-6'>
                <PrimaryButton href='/'>
                  Learn More About HOL
                </PrimaryButton>
              </div>
            </motion.div>
          </div>
