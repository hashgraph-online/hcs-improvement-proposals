...
import standardsSidebarItems from './src/data/standards-sidebar.json';

/**
 * Standards sidebar items are auto-generated from the docs/standards directory structure.
 * Run `pnpm generate-sidebar` or `pnpm sync-standards` to regenerate.
 */
...
const sidebars: SidebarsConfig = {
  ...
  standardsSidebar: [
    'definitions',
    {
      ...
      collapsible: true,
      collapsed: true,
      items: standardsSidebarItems as never[],
    },
    {
      type: 'category',
      label: 'Libraries',
