...
const client = new RegistryBrokerClient({
  baseUrl:
    process.env.REGISTRY_BROKER_BASE_URL ?? 'https://https://hol.org/registry/api/v1',
});
...
- The billing portal at [https://hol.org/registry/billing](https://https://hol.org/registry/billing) displays the same information in a UI after ledger auth.
