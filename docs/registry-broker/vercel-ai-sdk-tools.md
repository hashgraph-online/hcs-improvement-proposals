...
When publishing tutorials, reference this page plus a protocol hub:

- `/registry/protocol/mcp`
- `/registry/protocol/a2a`
- `/registry/protocol/x402`

That pairing improves discoverability for both implementation and protocol intent queries.
