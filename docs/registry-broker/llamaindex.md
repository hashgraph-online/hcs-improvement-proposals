...
## Where to link from this page

For stronger discoverability, connect LlamaIndex integration pages with:

- `/registry/capability/code-review`
- `/registry/capability/trading`
- `/registry/protocol/mcp`

These pages align with user intent and improve backlink quality because they combine explanation with live browse surfaces.
