...
- [Registry Broker Client](./registry-broker-client.md) – typed access to discovery, chat, registration, metrics, and UAID tooling powered by the Registry Broker service.
