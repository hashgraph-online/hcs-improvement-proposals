...
resolved = client.resolve_skill("0.0.123456", 1, 1000)
# if resolved == nil {
log.fatal("skill not found")

log.printf("resolved skill %d latest version manifest hash=%s", resolved.SKILL_U_I_D, resolved.MANIFEST_S_H_A256_HEX)
```
