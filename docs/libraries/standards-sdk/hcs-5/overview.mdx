...
// Inscribe SVG and mint (ModeHashinal is the default)
result, err := client.CreateHashinal(context.Background(), hcs5.CreateHashinalOptions{
	TokenID: "0.0.123456",
	Request: inscriber.StartInscriptionRequest{
		Content:     "PHN2ZyB4bWxucz0iaHR0cDovL3...", // base64 encoded SVG
		FileName:    "hashinal.svg",
		Mimetype:    "image/svg+xml",
		Name:        "Demo Hashinal",
		Description: "Minted with standards-sdk-go",
	},
})
if err != nil {
	panic(err)
}
fmt.Printf("Metadata: %s\n", result.Metadata) // hcs://1/<topicId>
```
...
# Inscribe SVG and mint (ModeHashinal is the default)
result = client.create_hashinal(
    token_id="0.0.123456",
    request={
        "content": "PHN2ZyB4bWxucz0iaHR0cDovL3...",
        "file_name": "hashinal.svg",
        "mimetype": "image/svg+xml",
        "name": "Demo Hashinal",
        "description": "Minted with standards-sdk",
    },
...
```python
result = client.mint(token_id="0.0.123456", metadata_topic_id="0.0.654321")
```
...
```python
result = client.create_hashinal(token_id="0.0.123456", request={"content": "PHN2ZyB4bWxucz0iaHR0cDovL3...", "file_name": "hashinal.svg", "mimetype": "image/svg+xml", "name": "Demo Hashinal", "description": "Minted with standards-sdk-go"})
```
