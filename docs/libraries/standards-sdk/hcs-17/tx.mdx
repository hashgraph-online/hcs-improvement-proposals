...
tx = hcs17.build_create_state_topic_tx(ttl_seconds=86400, admin_key=operatorPublicKey, submit_key=operatorPublicKey)
...
```python
msg = client.create_state_hash_message("ab…","0.0.1234","optional app memo", None,
tx = hcs17.build_state_hash_message_tx("0.0.7777", msg, "HCS-17 publish")
