...
topicID, err := client.CreateStateTopic(context.Background(), hcs17.CreateTopicOptions{
	TTL: 86400,
})
if err != nil {
	log.Fatal(err)
...
// Compute and publish a state hash
result, err := client.ComputeAndPublish(context.Background(), hcs17.ComputeAndPublishOptions{
