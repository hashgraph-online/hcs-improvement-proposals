...
tx = Hcs2Client.build_create_registry_tx(
    registry_type=0,  # 0 = Indexed
    ttl=86400,
    admin_key=True,
    submit_key=True,
)
...
```python
tx = hcs2.build_hcs2_register_tx(registry_topic_id="0.0.111", target_topic_id="0.0.222", metadata="https://example.com/metadata.json", memo="register")
...
```python
tx = hcs2.build_hcs2_update_tx(registry_topic_id="0.0.111", uid="1", target_topic_id="0.0.333", metadata="https://example.com/new.json", memo="updated")
```
...
```python
tx = hcs2.build_hcs2_delete_tx(registry_topic_id="0.0.111", uid="1", memo="removed")
```
...
```python
tx = hcs2.build_hcs2_migrate_tx(registry_topic_id="0.0.111", target_topic_id="0.0.999", metadata="migration v2", memo="migrate")
```
