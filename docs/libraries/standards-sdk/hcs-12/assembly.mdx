...
// client.CreateAssemblyTopic(ctx, ...)

// Register the assembly
assemblyResult, err := client.RegisterAssembly(ctx, assemblyRegistration)
if err != nil {
...
# Create assembly builder
assembly_builder = new AssemblyBuilder(logger)
...
# Register the assembly
assembly_result = client.register_assembly(...)
print('Assembly registered:', assemblyResult.id)
```
...
// Load assembly state
assembly, err := client.LoadAssembly(ctx, "0.0.987654")
if err != nil {
	log.Fatalf("failed: %v", err)
}
...
# Load assembly state
assembly = client.load_assembly(...)

print('Assembly name:', assembly.state.name)
print('Actions count:', assembly.actions.length)
print('Blocks count:', assembly.blocks.length)
