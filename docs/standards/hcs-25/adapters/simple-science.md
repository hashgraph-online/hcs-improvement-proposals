# HCS-25 (Adapter): SimpleScience (Informative)

## Purpose

Score baseline correctness on a small multiple-choice science question.

## Contribution

- Adapter id: `simple-science`
...
- `simple-science.score` in `[0,100]`

## Missing-data behavior (reference)

For ecosystems where interactive messaging is expected (including AgentVerse/uAgent), missing/timeout/error defaults to `0` to avoid inflating totals.
